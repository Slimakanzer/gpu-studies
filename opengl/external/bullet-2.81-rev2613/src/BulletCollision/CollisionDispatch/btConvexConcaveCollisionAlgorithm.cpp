...
void btConvexTriangleCallback::processTriangle(btVector3* triangle,int partId, int triangleIndex)
{
	...
	//printf("task_1_triangle %d",m_triangleCount++);
	...
	if (m_dispatchInfoPtr && m_dispatchInfoPtr->m_debugDraw && (m_dispatchInfoPtr->m_debugDraw->getDebugMode() &btIDebugDraw::DBG_DrawWireframe ))
	{
		...
		m_dispatchInfoPtr->m_debugDraw->drawLine(tr(task_1_triangle[0]),tr(task_1_triangle[1]),color);
		m_dispatchInfoPtr->m_debugDraw->drawLine(tr(task_1_triangle[1]),tr(task_1_triangle[2]),color);
		m_dispatchInfoPtr->m_debugDraw->drawLine(tr(task_1_triangle[2]),tr(task_1_triangle[0]),color);
	}
#endif
