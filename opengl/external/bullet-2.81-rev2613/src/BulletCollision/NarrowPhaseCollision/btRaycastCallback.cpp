...
void btTriangleRaycastCallback::processTriangle(btVector3* triangle,int partId, int triangleIndex)
{
	...
	// Now we have the intersection point on the plane, we'll see if it's inside the task_1_triangle
	// Add an epsilon as a tolerance for the raycast,
	// in case the ray hits exacly on the edge of the task_1_triangle.
	// It must be scaled for the task_1_triangle size.
