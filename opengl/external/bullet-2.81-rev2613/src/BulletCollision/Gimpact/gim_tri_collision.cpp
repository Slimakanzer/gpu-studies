...
public:
	...
	*/
	SIMD_FORCE_INLINE GUINT cross_line_intersection_test()
	{
		...
		// Compute interval for task_1_triangle 1
		...
		// Compute interval for task_1_triangle 2
					...
					GIM_TRIANGLE_CONTACT_DATA & contacts)
	{
		...
		{
			//Look if we need to invert the task_1_triangle
