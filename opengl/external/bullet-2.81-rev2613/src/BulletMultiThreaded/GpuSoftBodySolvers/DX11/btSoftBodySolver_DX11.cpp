	...
	if( forceUpdate || m_softBodySet.size() != softBodies.size() )
	{
		...
		for( int softBodyIndex = 0; softBodyIndex < softBodies.size(); ++softBodyIndex )
		{
			...
			for( int triangle = 0; triangle < numTriangles; ++triangle )
			{
				...
				// Increase vertex task_1_triangle counts for this task_1_triangle
...
{
	// TODO: Consider setting task_1_triangle data to "changed" here
...
void btDX11SoftBodySolver::updateSoftBodies()
{
	...
	// Go through task_1_triangle batches so updates occur correctly
