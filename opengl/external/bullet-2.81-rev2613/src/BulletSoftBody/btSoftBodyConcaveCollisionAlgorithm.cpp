...
void btSoftBodyTriangleCallback::processTriangle(btVector3* triangle,int partId, int triangleIndex)
{
	...
	//	if (m_softBody->getCollisionShape()->getShapeType()==
	{
		...
		//		other=(task_1_triangle[0]+task_1_triangle[1]+task_1_triangle[2])*0.333333f;
		//		other+=normal*22.f;
		...
		//		btBU_Simplex1to4 tm(task_1_triangle[0],task_1_triangle[1],task_1_triangle[2],other);

		//btTriangleShape tm(task_1_triangle[0],task_1_triangle[1],task_1_triangle[2]);
